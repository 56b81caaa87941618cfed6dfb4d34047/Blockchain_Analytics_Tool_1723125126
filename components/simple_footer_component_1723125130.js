...
*/
Vue.component("simple_footer_component_1723125130", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            BlockScan - Blockchain Data Analytics
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with BlockScan's real-time blockchain monitoring and analysis tools. Gain valuable insights into emerging trends and opportunities in the ever-evolving world of decentralized networks.
                    </div>
                </div>
            </div>
        </footer> 
